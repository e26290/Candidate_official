<template>
  <div class="news" :style="{
      ...
      <div class="container">
          <div class="sectionTitle">最新消息</div>
          <div class="timeline-container">
              <!--  時間線 -->
              <div class="timeline">
              <!--  最新消息項目 -->
                  <div class="timeline-item" :data-text="data.name" v-for="(data, index) in news" @mouseenter="handleMouseEnter(index)">
...
&-item {
  ...
  &:before {
    ...
    position: absolute;
    font-size: 13px;
    border-left: 2px solid rgba(#fff, .8);
    top: 70%;
    margin-top: -5px;
    padding-left: 15px;
    opacity: 1;
...
.news {
  transition: background 0.5s ease; // 加入過渡效果
}
